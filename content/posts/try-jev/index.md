...
TypeSafe AI の jev っていうモデルが話題なので試してみた。
...
jev の使い方としては、まず LLM と同じように自然言語で質問を投げかけて使う。が、jev は通常の LLM と違ってテキストを出力できない。その代わり、問いに対してこちらが提示した選択肢のどれにどの程度合致するか、みたいのを返すことができる。テキストを出力しないぶんとても高速で (500ms くらいで返事がくる) 、しかも安い。出力無料ですって。出力無料ってほんまか。
